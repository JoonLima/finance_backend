using System.Text;
using AutoMapper;
using FinanceBackEnd.Api.AutoMapper;
using FinanceBackEnd.Api.Contract.NaturezaDeLancamento;
using FinanceBackEnd.Api.Damain.Repository.Classes;
using FinanceBackEnd.Api.Damain.Repository.Interfaces;
using FinanceBackEnd.Api.Damain.Services.Classes;
using FinanceBackEnd.Api.Damain.Services.Interfaces;
using FinanceBackEnd.Api.Data;
...
static void ConfigurarAplicacao(WebApplication app)
{
    ...
    app.UseSwagger()
        .UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "FinanceBackEnd.Api v1");
